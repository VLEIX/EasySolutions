...
class HoursControllerTest < ActionController::TestCase
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post :create, hour: { atention: @hour.atention, dispon: @hour.dispon, local_id: @hour.local_id, worker_id: @hour.worker_id }
    end
  ...
  test "should update hour" do
    patch :update, id: @hour, hour: { atention: @hour.atention, dispon: @hour.dispon, local_id: @hour.local_id, worker_id: @hour.worker_id }
    assert_redirected_to hour_path(assigns(:hour))
  end
